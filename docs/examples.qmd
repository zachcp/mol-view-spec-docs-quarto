...
sel1.label({ text: 'aaRS Class II Signature' });


const sel2 = structure
    .component({ selector: { label_asym_id: 'B', label_seq_id: 537 } });

sel2.representation({ type: 'ball_and_stick' })
    .color({ color: '#ff0000' });

sel2.label({ text: 'aaRS Class II Signature' });
